...
/**
 * @fileOverview Summarizes text using GenAI.
 *
...
const summarizeTextPrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following text: {{{text}}}. Add one short, one-sentence summary of what you have generated to the 'progress' field in the output.`,
});
